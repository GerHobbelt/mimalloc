...
typedef enum mi_option_e {
  ...
  mi_option_abandoned_page_reset, //< (Unused/Deprecated) Reset free page memory when a thread terminates.
  ...
  mi_option_reset_delay,     ///< (Unused/Deprecated) Delay in milli-seconds before resetting a page (100ms by default)
